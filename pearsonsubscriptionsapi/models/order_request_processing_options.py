...
from pearsonsubscriptionsapi.models.billing_options import BillingOptions


class OrderRequestProcessingOptions(object):

    """Implementation of the 'orderRequestProcessingOptions' model.
    ...
    Attributes:
        run_billing (bool): Indicates if the current request needs to generate
            ...
            subscriptions included in this order. For REDEMPTION, default it
            to true.
        billing_options (BillingOptions): TODO: type description here.
    ...
    def __init__(self,
                 ...
                 billing_options=APIHelper.SKIP,
                 collect_payment=APIHelper.SKIP):
        """Constructor for the OrderRequestProcessingOptions class"""

        # Initialize members of the class
        if run_billing is not APIHelper.SKIP:
            self.run_billing = run_billing 
        if billing_options is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        billing_options = BillingOptions.from_dictionary(dictionary.get('billingOptions')) if 'billingOptions' in dictionary.keys() else APIHelper.SKIP
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'billing_options={self.billing_options!r}, '
                f'collect_payment={self.collect_payment!r})')

    def __str__(self):
        return (f'{self.__class__.__name__}('
                f'run_billing={self.run_billing!s}, '
                f'billing_options={self.billing_options!s}, '
